        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    TelegramAccount = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_TelegramAccount",
                table: "User",
                column: "TelegramAccount",
                unique: true,
                filter: "[TelegramAccount] IS NOT NULL");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelegramAccount = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
