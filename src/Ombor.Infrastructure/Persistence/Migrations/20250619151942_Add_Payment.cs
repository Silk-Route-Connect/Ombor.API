    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Direction = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
        ...
        migrationBuilder.CreateIndex(
            name: "IX_Payment_DateUtc",
            table: "Payment",
            column: "DateUtc");

        migrationBuilder.CreateIndex(
            name: "IX_Payment_PartnerId_Type",
            table: "Payment",
            columns: new[] { "PartnerId", "Type" });

        migrationBuilder.CreateIndex(
            name: "IX_PaymentAllocation_PaymentId_Type",
