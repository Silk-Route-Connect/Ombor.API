...
/// <summary>
/// A file uploaded with a transaction (receipt, invoice scan, etc.). Stored with enough metadata
/// for the client to render it without re-reading the file: original name, MIME type, size, and URL.
/// </summary>
public class TransactionAttachment : EntityBase, IOrganizationScoped
{
